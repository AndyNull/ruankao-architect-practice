...
writeFileSync(path.join(appRoot, "data", "study-materials.json"), JSON.stringify({
  ...
  note: "仅保存目录与来源地址。正文在用户点击后从来源仓库读取，不随本站题库重新发布。",
  materials,
}));
...
function createMaterial(group, groupLabel, folder, filename) {
  ...
  return {
    ...
    rawUrl: `https://raw.githubusercontent.com/YoungHong1992/ruankao-senior-architecture-designer/main/${encodeURI(sourcePath)}`,
  };
}
